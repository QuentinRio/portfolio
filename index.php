...
<body class="bg-primary">
      ...
      <div class="container px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ms-auto my-2 my-lg-0">
            ...
            <li class="nav-item"><a class="nav-link" href="#competences">Competences</a></li>
  ...
  <section class="bg-gradient" id="competences">
    <h2 class="text-center text-white ">Mes Competences</h2>
    <div class="py-1">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-sm-6 centerQuery">
            <div class="card">
              <img src="img/js-logo.svg" class="card-img-top" alt="logo-java">
              <div class="card-block">
                <h4 class="card-title">Card title</h4>
                <h6 class="card-subtitle text-muted">Support card subtitle</h6>
                <p class="card-text p-y-1">Some quick example text to build on the card title .</p>
        ...
        <form id="contact-form" name="contact-form" action="form.php" method="POST">
          ...
          <div class="">
            <div class="d-grid gap-4 col-6 mx-auto mt-5 p-5 ">
              <button class="btn btn-bordeau btn-place" type="button">Envoi</button>
            </div>
          </div>
